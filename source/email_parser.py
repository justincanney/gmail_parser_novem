...
mbox_obj = mailbox.mbox('source/Novem Workouts.mbox')
...
email_data = GmailMboxMessage(mbox_obj[0])
payload = email_data.read_email_payload()
print(type(payload))

section_header_regex = r'^.*:\n$\n'
title_regex = r'(\*\*\sWOD\s.*\r\n\-.*^)'

# content =  re.split(title_regex, payload[0][2])
print("=======================================")
print("=======================================")
print(payload[0])
# print("=======================================")
...
# l = re.compile(title_regex).split(payload[0][2])
# for a in l:
#     print('\n\n')
#     print(a)